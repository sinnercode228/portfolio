...
def main(argv: list[str] | None = None) -> int:
    ...
    p.add_argument("--start", default="2026-09-01",
                   help="first day of the production log, YYYY-MM-DD (default 2026-09-01); "
                        "the work log starts a week earlier and ends 2 days later, so the "
                        "invoice period filter has rows to skip")
    ...
    try:
        ...
        p.error(f"invalid --start {args.start!r}, expected YYYY-MM-DD")
